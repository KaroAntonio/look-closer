...
batch_loader = ButterLoader(pickle_dir+'pickled_butterflies',batch_size)
...
for i in range(train_iters):
	xtrain = batch_loader.next_batch()
	feed_dict={x:xtrain}
...
out_file=os.path.join(FLAGS.data_dir,"draw_data_test.npy")
np.save(out_file,[canvases,Lxs,Lzs])
print("Outputs saved in file: %s" % out_file)

ckpt_file=os.path.join(FLAGS.data_dir,"drawmodel_test.ckpt")
